...
<?php require_once __DIR__.'/../include/sidebar.php'; ?>
    ...
    <div id="content" class="span10" xmlns="http://www.w3.org/1999/html">
        ...
        <form action="index.php?c=tour&m=tourImages&id=<?php echo $tourId; ?>" method="post"  class="form-horizontal" enctype="multipart/form-data">
            <fieldset>
                <div class="control-group">
                    <label class="control-label" for="fileInput">File input</label>
                    <div class="controls">
                        <input class="input-file uniform_on" id="fileInput" name="image" type="file">
                        <input type="submit" name="createTour" value="Add Picture" class="btn btn-primary"/>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <?php foreach($images as $image): ?>
                    <div class="span3 ">
                        <a href="index.php?c=tour&m=deleteTourImage&id=<?php echo $image->getId(); ?>" class="btn btn-mini btn-danger ">Delete</a>
